...
setlocal
if "%~1"=="" (
  echo Usage: run_s2b_manual.bat "GOOGLE_SHEET_URL" [personal^|school] [run^|dry]
  echo Example: run_s2b_manual.bat "https://docs.google.com/spreadsheets/d/.../edit?gid=0#gid=0" personal run
  exit /b 2
)
set SHEET_URL=%~1
set ACCOUNT=%~2
